...
public class DemoApplication {
    ...
    CommandLineRunner commandLineRunner(EmpresaRepository empresaRepository, BancoDeAlimentosRepository bancoDeAlimentosRepository, DonacionRepository donacionRepository,
     AlergenosRepository alergenosRepository, TransporteRepository transporteRepository, BCryptPasswordEncoder passwordEncoder,UsuarioRepository usuarioRepository, ArticuloRepository articulosRepository) {
        return (args) -> {
...
if(articulosRepository.count() == 0) {
    List<Articulo> articulos = Arrays.asList(
        new Articulo(null, "La Nueva Ley de Desperdicio Alimentario en España:", "Implicaciones y Oportunidades para las Empresas", 
        "/img/LeyDesperdicior.jpg", "La entrada en vigor de la Ley 12/2023 de Prevención de las Pérdidas y el Desperdicio Alimentario marca un antes y después en la gestión de excedentes alimentarios en España. Esta normativa pionera establece nuevas obligaciones para las empresas del sector alimentario, transformando lo que antes era una opción en una responsabilidad legal.\r\n" + //
        ...
        new Articulo(null, "Contamos con un equipo capacitado en APPCC, garantizando seguridad y calidad en cada proceso.", "Garantizando Seguridad y Calidad en Cada Proceso con un Equipo Capacitado en APPCC\r\n" + //
                        "", "/img/seguridadAlimentaria.jpg", "En el entorno actual, la seguridad alimentaria y la calidad en los procesos son dos de los pilares fundamentales para cualquier empresa que maneje productos de consumo. Para asegurar que cada etapa en la producción se realice bajo los más altos estándares de higiene y seguridad, contamos con un equipo altamente capacitado en el sistema de Análisis de Peligros y Puntos Críticos de Control (APPCC), lo que nos permite garantizar la máxima protección para nuestros consumidores.\r\n" + //
                        "¿Qué es el APPCC?\r\n" + //
                        ...
                        ""),
        new Articulo(null,"Conectando Empresas con Bancos de Alimentos para Combatir el Desperdicio", "Save&Serve: Facilitamos la Solidaridad al Conectar Empresas con Bancos de Alimentos\r\n" + //
                        "", "/img/ConectandoEmpresas.jpg","En Save&Serve, nuestra misión es clara: ser el puente entre empresas con excedentes alimentarios y bancos de alimentos u organizaciones benéficas que luchan contra la inseguridad alimentaria. Ayudamos a prevenir el desperdicio de comida, garantizando que los productos sobrantes de hoteles, supermercados, restaurantes y otros proveedores lleguen a quienes más los necesitan, sin ningún costo para las ONGs o bancos de alimentos.\r\n" + //
